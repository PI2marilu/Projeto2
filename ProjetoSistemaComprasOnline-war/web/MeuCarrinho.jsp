                ...
                <div class="items">
                    <div class="shell">
                        ...
                        <h4>Meu Carrinho
                            ...
                            <a  title="Finalizar Compra" href="ConsultaPedidos" onClick="return confirm('Deseja finalizar a compra com <%=itensTotal%> item(s) no valor total de $<%=df.format(valorTotal)%> ?');">   Finalizar Compra</a>
                        </h4>
                        <%
                        } else {
                            ...
                            <div class="product-frame">
                                <div class="product">
                                    ...
                                    <div class="img-holder">	
                                        <a title="Comprar" href="#"><img src="css/images/<%=String.valueOf(listaMeuCarrinho.get(i).getIdProduto())%>.jpg" alt="Images of sunglasses" /></a>
                                    </div>								
