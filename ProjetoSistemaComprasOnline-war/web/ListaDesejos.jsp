                ...
                <div id="header">
                    ...
                    <div id="navigation">
                        ...
                        <ul>
                            ...
                            <li><a title="Catalog" href="Catalog.jsp">Catalog<span></span></a></li>
                        </ul>
                            ...
                            <div class="product-frame">
                                <div class="product">
                                    ...
                                    <div class="img-holder">	
                                        <a title="Comprar" href="ValidaUsuarioCompraLista?idProduto=<%=listaProdutos.get(j).getId()%>&idProcesso=carrinho&quantidade=1&valor=<%=listaProdutos.get(j).getPreco()%>"><img src="css/images/<%=String.valueOf(listaDesejoSessao.get(i).getIdProduto())%>.jpg" alt="Images of sunglasses" /></a>
                                    </div>								
                                    <div class="img-bottom"></div>
                                    <div class="price-box">
                                        <p>price</p>
                                        <p class="price"><span class="dollar">$</span><%=String.valueOf(listaProdutos.get(i).getPreco())%></sup></p>
                                    </div>
                                    <div class="product-entry">
                                        <p class="model"><%=String.valueOf(listaProdutos.get(i).getModelo())%></p>
                                        <p class="model"><span>product: <%=String.valueOf(listaProdutos.get(i).getId())%></span></p>
                                       <p class="product-info"><%=String.valueOf(listaProdutos.get(i).getDescricao())%> 
