                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="idEntrega" align="right" required="true">
                                                <option/>
                                                <option value="meuEndereco">Meu Endereço: <%=usuario.getEndereco1()%> , <%=usuario.getNumero1()%> </option>
                                                <option value="amigoEndereco"> Endereço p/presente: <%=usuario.getEndereco2()%>  , <%=usuario.getNumero2()%> </option>
                                            </select>
                                           
                                     </td>
                                                            <td>  Total a pagar $<%=df.format(valorTotal)%>&nbsp; <input type="submit" value="Pagar"/> </td> 
                                                            </tr>
